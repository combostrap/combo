...
class UrlRewrite
{
    ...
    public static function sendErrorMessage()
    {
        ...
        $hrefPermanentFunctionality = "https://combowiki.combostrap.com/page/canonical-url-4kxbb9fd#permanent";
        $hrefNiceUrl = "https://combowiki.combostrap.com/admin/nice-url-noln5keo";
