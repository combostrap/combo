  ...
  function getModel(): array
  {
    ...
    try {
      ...
      try {
        ...
        [$primaryColorRed, $primaryColorGreen, $primaryColorBlue] = $primaryColor->toRgbChannels();
        $model[BrandingColors::PRIMARY_COLOR_TEMPLATE_ATTRIBUTE] = $primaryColor->toCssValue();
        $model[BrandingColors::PRIMARY_COLOR_RGB_TEMPLATE_ATTRIBUTE] = "$primaryColorRed, $primaryColorGreen, $primaryColorBlue";
