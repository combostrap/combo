...
class Bootstrap
{
  ...
  public const VERSION_538 = self::DEFAULT_MAJOR . ".3.8";
  public const DEFAULT_BOOTSTRAP_4_VERSION = "4.5.0";
  public const DEFAULT_BOOTSTRAP_5_VERSION = self::VERSION_538;
  /**
   * The separator in {@link Bootstrap::CONF_BOOTSTRAP_VERSION_STYLESHEET}
   */
  public const BOOTSTRAP_VERSION_STYLESHEET_SEPARATOR = " - ";
  public const DEFAULT_BOOTSTRAP_STYLESHEET_4_VERSION = self::DEFAULT_BOOTSTRAP_4_VERSION . self::BOOTSTRAP_VERSION_STYLESHEET_SEPARATOR . self::DEFAULT_STYLESHEET_NAME;
  public const DEFAULT_BOOTSTRAP_STYLESHEET_5_VERSION = self::DEFAULT_BOOTSTRAP_5_VERSION . self::BOOTSTRAP_VERSION_STYLESHEET_SEPARATOR . self::DEFAULT_STYLESHEET_NAME;
  public const DEFAULT_BOOTSTRAP_VERSION_STYLESHEET = self::DEFAULT_BOOTSTRAP_STYLESHEET_5_VERSION;
